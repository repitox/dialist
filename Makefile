...
help:
	...
	@echo "  make deploy-netangels - Развернуть на NetAngels хостинге"
	@echo ""
	@echo "🌐 После запуска:"
...
# Развертывание на NetAngels хостинге
deploy-netangels:
	@echo "🚀 Развертывание на NetAngels хостинге..."
	@./deploy-to-netangels.sh
